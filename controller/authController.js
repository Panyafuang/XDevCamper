...
//
    ...
    const sendTokenResponse = (user, statusCode, res) => {
        ...
        const token = user.singedJwtWebToken();
...
exports.forgotPassword = asyncHandler(async(req, res, next) => {
    ...
    const message = `You are receiving this email because you (or someone lese) has requested the reset of a password. Please make a PUT request to: \n\n ${resetUrl}`;
